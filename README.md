...
# Black-Litterman with Normally distributed prior
...
Basically, the Black-Litterman model is a complex of weighted averages of the implied
...
contains the variance of the views, where ωk is the uncertainty in the k-th view. If ω = 0 it
means that the manager if fully confident about the view.
